...
export const OriginStory = () => {
  ...
  return (
    <section id="story" className="py-28 lg:py-36 bg-slate-50 dark:bg-[#0B101D] text-slate-900 dark:text-slate-100 relative overflow-hidden border-y border-slate-200/80 dark:border-white/10 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="apple-glass-card rounded-3xl p-3 border border-slate-200/80 dark:border-white/10 overflow-hidden group">
              ...
              <div className="p-5 bg-white dark:bg-slate-900/90 rounded-2xl mt-3 border border-slate-200 dark:border-white/10">
                <div className="flex items-center justify-between text-xs font-mono font-bold text-slate-800 dark:text-slate-200 mb-2">
                  <span>ANOR & ISO HYGIENE AUDIT</span>
                  <span className="text-emerald-600 dark:text-emerald-400 font-extrabold">100% COMPLIANT</span>
                </div>
                <div className="w-full bg-slate-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-gradient-to-r from-cyan-500 to-emerald-500 h-full w-full" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg sm:text-xl text-cyan-700 dark:text-cyan-400 font-medium leading-relaxed">
                {t.story.subtitle}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="p-4.5 rounded-2xl apple-glass-card text-slate-800 dark:text-white text-xs sm:text-sm font-semibold flex items-center gap-3">
